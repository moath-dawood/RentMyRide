    ...
    <Grid sx={{ padding: "30px", margin: "auto", backgroundColor: { md: "white", xs: "#F6F7F9" } }} container>
      <Grid sx={{ paddingTop: "50px", paddingBottom: "30px", marginBottom: "30px", borderBottom: "1px solid", borderColor: "rgba(13,13,13,0.16)" }} container xs={12}>
        <Grid sx={{ marginBottom: "15px" }} justifyContent={{ xs: 'flex-end', md: 'none' }} item xs={12} lg={6.3}>
          <RentMyRide />
          <Grid sx={{ marginTop: "15px", marginBottom: "20px"}} xs={5.5} md={3.2}>
        ...
        <Grid container justifyContent={{ lg: 'space-evenly', md: 'flex-start' }} xs={12} lg={5.4} >
          <Grid item xs={6} md={4} lg={1.5} order={{ lg: 1, xs: 1 }}>
            <Grid sx={{ marginBottom: "15px" }}><Typography variant='main' fontWeight={600}>About</Typography></Grid>
          ...
          <Grid item xs={6} md={4} lg={1.5} order={{ lg: 2, xs: 3 }}>
            <Grid sx={{ marginBottom: "15px" }}><Typography variant='main' fontWeight={600} >Community</Typography></Grid>
          ...
          <Grid item xs={6} md={4} lg={1.5} order={{ lg: 3, xs: 2 }}>
            <Grid sx={{ marginBottom: "15px" }}><Typography variant='main' fontWeight={600}>Socials</Typography></Grid>
