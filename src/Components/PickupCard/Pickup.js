...
export default function Pickup() {
    ...
    return (
        <Box margin={"auto"} marginY={"50px"} padding={"20px"} borderRadius={"12px"} sx={{ backgroundColor: "white", width:"fit-content", height:{xs:"300px", sm:"fit-content"} }}>
            <Grid container alignItems={"center"} justifyContent={"space-around"} xs={3.5} sm={2.2} md={1.8} lg={1.6}>
                <CardMedia
